...
public class EncodingDetect {
	public static void main(String[] args) {
		...
		String encode=getJavaEncodeFile(file);
	 ...
	 * @return 文件的编码
	 */
	public static String getJavaEncodeFile(String filePath){
		BytesEncodingDetect s = new BytesEncodingDetect();
		String fileCode = BytesEncodingDetect.javaname[s.detectEncoding(new File(filePath))];
		return fileCode;
	}
	public static String getJavaEncodeByte(byte[] data){
		BytesEncodingDetect s = new BytesEncodingDetect();
		String fileCode = BytesEncodingDetect.javaname[s.detectEncoding(data)];
		return fileCode;
	}
